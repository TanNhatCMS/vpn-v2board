...
<head>
    <meta charset="UTF-8">
    <title>Lời nhắc lưu lượng</title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            Lưu lượng truy cập gói của bạn trong tháng này đã được sử dụng <strong> 80%</strong>. Vui lòng sắp xếp nó một cách hợp lý để tránh kiệt sức trước.                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            (Email này được hệ thống gửi tự động, vui lòng không trả lời trực tiếp)                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
