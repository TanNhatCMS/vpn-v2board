...
class UserService
{
    private function calcResetDayByMonthFirstDay(): string
    {
        $today = date('d');
    ...
    private function calcResetDayByExpireDay(int $expiredAt): int
    {
    ...
    public function getResetDay(User $user): int|string|null
    {
        if (! isset($user->plan)) {
    ...
    public function trafficFetch(array $server, string $protocol, array $data): void
    {
